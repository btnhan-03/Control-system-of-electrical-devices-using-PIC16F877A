...
void main()
{
    ...
    while(1)
    {
        if((*(volatile Type_bitB*)0x06).RB7==0|| (*(volatile Type_bitC*)0x07).RC0==0)
        {
            count++;

            if(count<20)
            {
                (*(volatile Type_bitA*)0x05).RA0=0;
            }
            if(count>=20)
            {
                (*(volatile Type_bitA*)0x05).RA0=1;
            }
            if(count==100)
            {
                count=0;
       ...
       else if((*(volatile Type_bitC*)0x07).RC1==0||(*(volatile Type_bitC*)0x07).RC2==0)
        {
            count--;
             if(count<=0)
        {
